...
class ExpenseControlTests {
	...
	public void setUp() {
		...
		address.setId(1L);
		person = new Person("Gina", "gina@gmail.com", LocalDate.now(), GenderEnum.MASCULINO, address);
		person.setId(1L);
		expenseControl = new ExpenseControl(ExpenseEnum.DESPESA, "Test", LocalDate.now(), new BigDecimal("50.0"),
				person);
	...
	public void should_saveExpenseControl_when_use_service() {
		...
		assertEquals(ExpenseEnum.DESPESA, responseDto.getExpense());
	...
	public void should_saveExpenseControl_when_use_repository() {
		...
		assertEquals(ExpenseEnum.DESPESA, response.getExpense());
	...
	public void should_findExpenseControl_when_use_service() {
		...
		assertEquals(ExpenseEnum.DESPESA, expenseControlReturnDto.getExpense());
	...
	public void should_findExpenseControl_when_use_repository() {
		...
		assertEquals(ExpenseEnum.DESPESA, expenseControlReturn.getExpense());
