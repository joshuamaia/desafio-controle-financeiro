...
class PersonTests {
	...
	public void should_savePerson_when_use_service() {
		...
		assertEquals(GenderEnum.MASCULINO, responseDto.getGender());
	...
	public void should_savePerson_when_use_repository() {
		...
		assertEquals(GenderEnum.MASCULINO, response.getGender());
	...
	public void should_findPerson_when_use_service() {
		...
		assertEquals(GenderEnum.MASCULINO, personReturnDto.getGender());
	...
	public void should_findPerson_when_use_repository() {
		...
		assertEquals(GenderEnum.MASCULINO, personReturn.getGender());
